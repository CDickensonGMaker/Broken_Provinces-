...
| File | Purpose |
|------|---------|
| `scripts/autoload/cell_streamer.gd` | Core streaming logic |
| `scripts/data/world_grid.gd` | World data and locations |
| `scripts/autoload/player_gps.gd` | Position tracking |
| `scripts/generation/wilderness_room.gd` | Procedural terrain |
| `scripts/generation/town_generator.gd` | Procedural towns |
