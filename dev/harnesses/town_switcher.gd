...
const TOWN_FILES: Dictionary = {
	"Thornfield": "res://data/towns/thornfield.json",
	"Millbrook": "res://data/towns/millbrook.json",
	"Aberdeen": "res://data/towns/aberdeen.json",
	"Larton": "res://data/towns/larton.json",
	"Pirate Cove": "res://data/towns/pirate_cove.json",
	"Elven Sanctuary": "res://data/towns/elven_sanctuary.json",
	"Combat Arena": "res://data/towns/combat_arena.json",
}
