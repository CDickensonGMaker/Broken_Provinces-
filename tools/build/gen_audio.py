...
tree is the only tree it knows about.
    ...
    python tools/build/gen_audio.py sfx
    python tools/build/gen_audio.py ambience
    python tools/build/gen_audio.py voice
    python tools/build/gen_audio.py music
    python tools/build/gen_audio.py all
