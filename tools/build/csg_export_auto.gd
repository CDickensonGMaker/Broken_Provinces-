...
const KAZAN_DUN_ROOMS: Array[String] = [
	"res://scenes/generation/kazan_dun/kd_armory.tscn",
	"res://scenes/generation/kazan_dun/kd_barricade.tscn",
	"res://scenes/generation/kazan_dun/kd_bathhouse.tscn",
	"res://scenes/generation/kazan_dun/kd_bridge_connector.tscn",
	"res://scenes/generation/kazan_dun/kd_bridge_gatehouse.tscn",
	"res://scenes/generation/kazan_dun/kd_bridge_span.tscn",
	"res://scenes/generation/kazan_dun/kd_command_center.tscn",
	"res://scenes/generation/kazan_dun/kd_common_quarters.tscn",
	"res://scenes/generation/kazan_dun/kd_corridor_corner.tscn",
	"res://scenes/generation/kazan_dun/kd_corridor_straight.tscn",
	"res://scenes/generation/kazan_dun/kd_council_chamber.tscn",
	"res://scenes/generation/kazan_dun/kd_feast_hall.tscn",
	"res://scenes/generation/kazan_dun/kd_forge_main.tscn",
	"res://scenes/generation/kazan_dun/kd_goblin_camp.tscn",
	"res://scenes/generation/kazan_dun/kd_great_hall_corridor.tscn",
	"res://scenes/generation/kazan_dun/kd_kitchen.tscn",
	"res://scenes/generation/kazan_dun/kd_mine_shaft.tscn",
	"res://scenes/generation/kazan_dun/kd_noble_quarters.tscn",
	"res://scenes/generation/kazan_dun/kd_ritual_chamber.tscn",
	"res://scenes/generation/kazan_dun/kd_rune_ward_hall.tscn",
	"res://scenes/generation/kazan_dun/kd_stairwell_down.tscn",
	"res://scenes/generation/kazan_dun/kd_storage_cellar.tscn",
	"res://scenes/generation/kazan_dun/kd_throne_room.tscn",
	"res://scenes/generation/kazan_dun/kd_treasury.tscn",
]
