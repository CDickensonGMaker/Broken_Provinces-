...
func _spawn_rescue_hostage() -> void:
	# rescue_merchant_daughter_2: the camp with a Bandit Boss in it
	HostageNPC.spawn_hostage(
		self, Vector3(-9, 1, 6), "hostage_merchant_daughter", "Merchant's Daughter",
		"rescue_merchant_daughter_2", "free_hostage")
