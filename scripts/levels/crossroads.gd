## crossroads.gd - The Crossroads region (placeholder)
## A major intersection of roads east of Elder Moor
extends Node3D

const ZONE_ID := "region_crossroads"
...
func _ready() -> void:
	...
	print("[Crossroads] Region initialized (placeholder)")


func _setup_navigation() -> void:
	if not nav_region:
		push_warning("[Crossroads] NavigationRegion3D not found")
		return
