...
## Enemy ship sprites
const PIRATE_SHIP_PORTSIDE := "res://assets/sprites/legacy/vehicles/pirate_ship/pirate_ship_portside.png"
const PIRATE_SHIP_STARBOARDSIDE := "res://assets/sprites/legacy/vehicles/pirate_ship/pirate_ship_starboardside.png"
const PIRATE_SHIP_FRONT := "res://assets/sprites/legacy/vehicles/pirate_ship/pirate_ship_front.png"
...
func _spawn_crew() -> void:
	...
	helmsman = _spawn_crew_member(helm_pos, "Ship's Helmsman", false, "res://assets/sprites/legacy/npcs/civilians/guard_civilian.png")
	if helmsman:
	...
	deck_hand_1 = _spawn_crew_member(deck1_pos, "Deck Hand", true, "res://assets/sprites/legacy/npcs/combat/bandit_3.png")
	if deck_hand_1:
	...
	deck_hand_2 = _spawn_crew_member(deck2_pos, "Deck Hand", true, "res://assets/sprites/legacy/npcs/civilians/guy_civilian1.png")
	if deck_hand_2:
...
func _spawn_boarding_pirate_async(enemy_data_path: String, start_pos: Vector3, end_pos: Vector3, display_name: String, delay: float) -> EnemyBase:
	...
	# Get sprite texture
	var sprite_path: String = enemy_data.sprite_path if enemy_data.sprite_path else "res://assets/sprites/legacy/enemies/humanoid/pirate_seadog.png"
...
func _spawn_sea_creature() -> void:
	...
	var tentacle_sprites: Array[String] = [
		"res://assets/sprites/legacy/enemies/beasts/sea monsters/tentacle_1.png",
		"res://assets/sprites/legacy/enemies/beasts/sea monsters/tentacle_2.png",
		"res://assets/sprites/legacy/enemies/beasts/sea monsters/tentacle_animation.png",
	]
...
func _travel_to_destination(port_id: String) -> void:
	...
	if not location_info.is_empty():
		...
		if SceneManager:
			SceneManager.change_scene("res://scenes/generation/wilderness/wilderness.tscn", "default")
		return
