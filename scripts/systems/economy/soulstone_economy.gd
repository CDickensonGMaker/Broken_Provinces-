...
func _get_quest_reward_location(index: int) -> String:
	...
	var quest_ids: Array[String] = [
		...
		"dungeon_clear_kazan_dun_01",
		"dungeon_clear_kazan_dun_02",
		"dungeon_clear_kazan_dun_03",
		"dungeon_clear_kazan_dun_04",
		"dungeon_clear_kazan_dun_05",
...
func _get_dungeon_location(index: int) -> String:
	var dungeon_ids: Array[String] = [
		...
		"kazan_dun_01", "kazan_dun_02", "kazan_dun_03", "kazan_dun_04", "kazan_dun_05",
		"kazan_dun_06", "kazan_dun_07", "kazan_dun_08", "kazan_dun_09", "kazan_dun_10",
