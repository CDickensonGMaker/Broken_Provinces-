...
func _spawn_freed_apprentice() -> void:
	...
	var ApprenticeMarcusScript: GDScript = preload("res://scripts/characters/npcs/apprentice_marcus_npc.gd")
...
static func create_crystal_hearts_room(
	...
	var portal_script: GDScript = load("res://scripts/systems/puzzles/crystal_portal.gd")
	if portal_script:
