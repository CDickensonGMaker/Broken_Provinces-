...
var _default_guard_dialogue: DialogueData = preload("res://data/dialogue/resources/guard_generic.tres")
...
const GUARD_SPRITE_DWARF := "res://assets/sprites/legacy/npcs/civilians/guard_civilian.png"
const GUARD_SPRITE_ROMAN := "res://assets/sprites/legacy/npcs/civilians/guard2_civilian.png"
