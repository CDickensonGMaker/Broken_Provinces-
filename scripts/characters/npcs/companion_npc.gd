...
func _fire_projectile() -> void:
	...
	var projectile_path: String = "res://data/projectiles/arrow_basic.tres"
...
func take_damage(amount: int, damage_type: Enums.DamageType = Enums.DamageType.PHYSICAL, attacker: Node = null) -> int:
	...
	var armor_mult: float = 1.0 if CombatManager.is_armor_already_applied(self) else 100.0 / (100.0 + float(follower_armor))
