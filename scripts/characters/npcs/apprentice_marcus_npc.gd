...
const MARCUS_SPRITE_PATH := "res://assets/sprites/legacy/npcs/civilians/wizard_civilian.png"
const MARCUS_DIALOGUE_PATH := "res://data/dialogue/resources/apprentice_marcus.json"
