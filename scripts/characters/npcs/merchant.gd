...
func _create_merchant_mesh() -> void:
	...
	if not texture_to_use:
		...
		if is_female:
			fallback_paths = [
				{"path": "res://assets/sprites/legacy/npcs/civilians/lady_in_red.png", "h": 8, "v": 1, "size": 0.0256},
				{"path": "res://assets/sprites/legacy/npcs/civilians/barmaid_3x3.png", "h": 3, "v": 1, "size": 0.0256},
				{"path": "res://assets/sprites/legacy/npcs/merchants/merchant_civilian.png", "h": 1, "v": 1, "size": 0.0256},
			]
		else:
			fallback_paths = [
				{"path": "res://assets/sprites/legacy/npcs/merchants/merchant_civilian.png", "h": 1, "v": 1, "size": 0.0256},
				{"path": "res://assets/sprites/legacy/npcs/civilians/man_civilian.png", "h": 8, "v": 2, "size": 0.0256},
			]
...
## sprite_path: Optional path to sprite sheet texture (e.g., "res://assets/sprites/legacy/npcs/merchant.png")
