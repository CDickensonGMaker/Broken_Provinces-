...
extends "res://scripts/characters/npcs/merchant.gd"

## Sprite assets for random gender selection
const INNKEEPER_SPRITE_MALE := "res://assets/sprites/legacy/npcs/merchants/Innkeeper_man.png"
const INNKEEPER_SPRITE_FEMALE := "res://assets/sprites/legacy/npcs/merchants/Innkeeper_woman.png"
