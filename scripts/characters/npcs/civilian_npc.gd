...
##
## `visual` is the body, whatever kind it is (scripts/characters/visuals/character_visual.gd).
...
static func spawn_woman(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/civilians/lady_in_red.png"
	var h_frames: int = 8
	var v_frames: int = 1
...
static func spawn_man(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/civilians/man_civilian.png"
	var h_frames: int = 1
	var v_frames: int = 1
...
static func spawn_barmaid_blonde(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/civilians/barmaid_4x4.png"
	var h_frames: int = 1
	var v_frames: int = 1
...
static func spawn_barmaid_brunette(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/civilians/barmaid_3x3.png"
	var h_frames: int = 1
	var v_frames: int = 1
...
static func spawn_wizard(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/civilians/wizard_mage.png"
...
static func spawn_dwarf_guard(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/dwarves/dwarf_2.png",
...
static func spawn_dwarf_warrior(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/dwarves/dwarf_3.png",
		4,  # dwarf_2/dwarf_3/dwarf_molten2 are 266x96 four-pose strips, not 48x96
		1,
		false,
		PIXEL_SIZE_DWARF
...
static func spawn_dwarf_refugee(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var sprite_path: String = "res://assets/sprites/legacy/npcs/dwarves/dwarf_3.png" if _rf() < 0.5 else "res://assets/sprites/legacy/npcs/dwarves/dwarf_2.png"
...
static func spawn_dwarf_wounded(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	npc.sprite_texture = load("res://assets/sprites/legacy/npcs/dwarves/dwarf_3.png")
...
static func spawn_dwarf_forge_master(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/dwarves/dwarf_molten1.png",
		4,  # dwarf_2/dwarf_3/dwarf_molten2 are 266x96 four-pose strips, not 48x96
		1,
		false,
		PIXEL_SIZE_DWARF
...
static func spawn_dwarf_forge_worker(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/dwarves/dwarf_molten2.png",
		4,  # dwarf_2/dwarf_3/dwarf_molten2 are 266x96 four-pose strips, not 48x96
		1,
		false,
		PIXEL_SIZE_DWARF
...
static func spawn_dwarf_forge_guard(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/dwarves/dwarf_molten3.png",
		4,  # dwarf_2/dwarf_3/dwarf_molten2 are 266x96 four-pose strips, not 48x96
		1,
		false,
		PIXEL_SIZE_DWARF
...
static func spawn_guy_green_vest(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/civilians/guy_civilian1.png",
...
static func spawn_pink_lady(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/civilians/pinklady.png",
		1,  # Single frame (48x96)
		1,  # Single frame
		false,
...
static func spawn_magic_shop_worker(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/merchants/magic_shop_worker.png",
...
static func spawn_seductress(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/civilians/seductress_civilian_Front.png",
	...
	if npc.billboard:
		var front_tex: Texture2D = load("res://assets/sprites/legacy/npcs/civilians/seductress_civilian_Front.png")
		var back_tex: Texture2D = load("res://assets/sprites/legacy/npcs/civilians/seductress_civilian_back.png")
...
static func spawn_blue_dress_lady(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent,
		pos,
		"res://assets/sprites/legacy/npcs/civilians/seductress2_civilian.png",
		1,  # Single frame (48x96)
		1,  # Single frame
		false,
...
static func spawn_female_noble(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/civilians/female_noble1.png",
...
static func spawn_male_noble(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/civilians/man_noble1.png",
		1, 1, false, PIXEL_SIZE_NOBLE
	)
	npc.tint_color = Color.WHITE
...
static func spawn_female_gladiator(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/combat/female_gladiator1.png",
...
static func spawn_male_gladiator(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/combat/male_gladiator1.png",
		1, 1, false, PIXEL_SIZE_GLADIATOR
	)
	npc.tint_color = Color.WHITE
...
static func spawn_female_hunter(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/civilians/female_hunter.png",
...
static func spawn_guard_civilian(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/civilians/guard_civilian.png",
...
static func spawn_guard_roman_civilian(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/civilians/guard2_civilian.png",
		1, 1, false, PIXEL_SIZE_GUARD_CIV
	)
	npc.tint_color = Color.WHITE
...
static func spawn_wizard_wild(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/civilians/wizard_wild.png",
...
static func spawn_wizard_civilian(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/civilians/wizard_civilian.png",
		1, 1, false, PIXEL_SIZE_WIZARD_CIV
	)
	npc.tint_color = Color.WHITE
	_assign_unique_name(npc, zone_id, false, "Mage")
...
static func spawn_bard(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/civilians/bard_civilian.png",
...
static func spawn_merchant_civilian(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var npc := spawn_civilian(
		parent, pos,
		"res://assets/sprites/legacy/npcs/merchants/merchant_civilian.png",
...
static func spawn_bandit_civilian(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	var sprite: String = "res://assets/sprites/legacy/npcs/combat/thief.png" if _rf() < 0.5 else "res://assets/sprites/legacy/npcs/combat/bandit_3.png"
	var npc := spawn_civilian(
		parent, pos,
		sprite,
...
static func spawn_monk_tan(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/temple/monk_1.png"
	var h_frames: int = 1
	var v_frames: int = 1
...
static func spawn_monk_brown(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/temple/monk_2.png"
	var h_frames: int = 1
	var v_frames: int = 1
	var pixel_size: float = PIXEL_SIZE_MONK
...
static func spawn_monk_purple(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/temple/monk_3_purple.png"
	var h_frames: int = 1
	var v_frames: int = 1
	var pixel_size: float = PIXEL_SIZE_MONK
...
static func spawn_innkeeper_male(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/merchants/Innkeeper_man.png"
...
static func spawn_innkeeper_female(parent: Node, pos: Vector3, zone_id: String = "") -> CivilianNPC:
	...
	var sprite_path: String = "res://assets/sprites/legacy/npcs/merchants/Innkeeper_woman.png"
	var h_frames: int = 1
	var v_frames: int = 1
	var pixel_size: float = PIXEL_SIZE_INNKEEPER
