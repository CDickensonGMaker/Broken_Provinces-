# File: scripts/characters/player/first_person_arms.gd
...
const UNARMED_IDLE_PATH := "res://assets/sprites/legacy/weapons/unarmed_idle.png"
const UNARMED_PUNCH_PATH := "res://assets/sprites/legacy/weapons/unarmed_punch.png"
