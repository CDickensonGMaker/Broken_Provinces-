...
func _try_become_ranged() -> void:
	if randf() < ranged_chance:
		...
		if ranged_projectile_on_random:
			...
			var default_arrow := load("res://data/projectiles/arrow_basic.tres") as ProjectileData
			if default_arrow:
...
func _setup_rat_directional_sprites() -> void:
	_is_rat_enemy = true
	_rat_tex_forward = load("res://assets/sprites/legacy/enemies/beasts/rat_moving_forward.png")
	_rat_tex_away = load("res://assets/sprites/legacy/enemies/beasts/rat_moving_away.png")
	_rat_tex_right = load("res://assets/sprites/legacy/enemies/beasts/rat_moving_right.png")
...
static func spawn_billboard_enemy(parent: Node, pos: Vector3, enemy_data_path: String, sprite_texture: Texture2D, h_frames: int = 4, v_frames: int = 4, p_zone_danger: int = 1) -> EnemyBase:
	...
	var enemy_scene: PackedScene = load("res://scenes/characters/enemy_base.tscn")
	if not enemy_scene:
...
func _setup_skeleton_sprites() -> void:
	# Load textures
	var walk_tex: Texture2D = load("res://assets/sprites/legacy/enemies/undead/skeleton_walking.png")
	var attack_tex: Texture2D = load("res://assets/sprites/legacy/enemies/undead/skeleton_attacking.png")
