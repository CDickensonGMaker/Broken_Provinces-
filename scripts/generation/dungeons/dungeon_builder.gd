...
const ROOM_SCENES: Dictionary = {
	DungeonGridData.RoomType.START: "res://scenes/generation/dungeon_rooms/room_start.tscn",
	DungeonGridData.RoomType.CORRIDOR_NS: "res://scenes/generation/dungeon_rooms/corridor_ns.tscn",
	DungeonGridData.RoomType.CORRIDOR_EW: "res://scenes/generation/dungeon_rooms/corridor_ew.tscn",
	DungeonGridData.RoomType.TURN_NE: "res://scenes/generation/dungeon_rooms/turn_ne.tscn",
	DungeonGridData.RoomType.TURN_NW: "res://scenes/generation/dungeon_rooms/turn_nw.tscn",
	DungeonGridData.RoomType.TURN_SE: "res://scenes/generation/dungeon_rooms/turn_se.tscn",
	DungeonGridData.RoomType.TURN_SW: "res://scenes/generation/dungeon_rooms/turn_sw.tscn",
	DungeonGridData.RoomType.T_NORTH: "res://scenes/generation/dungeon_rooms/t_north.tscn",
	DungeonGridData.RoomType.T_SOUTH: "res://scenes/generation/dungeon_rooms/t_south.tscn",
	DungeonGridData.RoomType.T_EAST: "res://scenes/generation/dungeon_rooms/t_east.tscn",
	DungeonGridData.RoomType.T_WEST: "res://scenes/generation/dungeon_rooms/t_west.tscn",
	DungeonGridData.RoomType.CROSS: "res://scenes/generation/dungeon_rooms/cross.tscn",
	DungeonGridData.RoomType.ROOM_SMALL: "res://scenes/generation/dungeon_rooms/room_small.tscn",
	DungeonGridData.RoomType.ROOM_SMALL_SECRET: "res://scenes/generation/dungeon_rooms/room_small_secret.tscn",
	DungeonGridData.RoomType.ROOM_MEDIUM: "res://scenes/generation/dungeon_rooms/room_medium.tscn",
	DungeonGridData.RoomType.ROOM_LARGE: "res://scenes/generation/dungeon_rooms/room_large.tscn",
	DungeonGridData.RoomType.ROOM_BOSS: "res://scenes/generation/dungeon_rooms/room_boss.tscn",
	DungeonGridData.RoomType.DEAD_END_N: "res://scenes/generation/dungeon_rooms/dead_end_n.tscn",
	DungeonGridData.RoomType.DEAD_END_S: "res://scenes/generation/dungeon_rooms/dead_end_s.tscn",
	DungeonGridData.RoomType.DEAD_END_E: "res://scenes/generation/dungeon_rooms/dead_end_e.tscn",
	DungeonGridData.RoomType.DEAD_END_W: "res://scenes/generation/dungeon_rooms/dead_end_w.tscn",
	DungeonGridData.RoomType.HALLWAY_NS: "res://scenes/generation/dungeon_rooms/hallway_ns.tscn",
	DungeonGridData.RoomType.HALLWAY_EW: "res://scenes/generation/dungeon_rooms/hallway_ew.tscn",
	## Cave room scenes - using new mine kit pieces
	DungeonGridData.RoomType.CAVE_ENTRANCE: "res://scenes/generation/caves/mine_entrance.tscn",
	DungeonGridData.RoomType.CAVE_EXIT: "res://scenes/generation/caves/mine_dead_end_medium.tscn",
	DungeonGridData.RoomType.CAVE_CORRIDOR_NS: "res://scenes/generation/caves/mine_corridor_ns_standard.tscn",
	DungeonGridData.RoomType.CAVE_CORRIDOR_EW: "res://scenes/generation/caves/mine_corridor_ew_narrow.tscn",
	DungeonGridData.RoomType.CAVE_CORNER_NE: "res://scenes/generation/caves/mine_corner_se.tscn",
	DungeonGridData.RoomType.CAVE_CORNER_NW: "res://scenes/generation/caves/mine_corner_nw.tscn",
	DungeonGridData.RoomType.CAVE_CORNER_SE: "res://scenes/generation/caves/mine_corner_se.tscn",
	DungeonGridData.RoomType.CAVE_CORNER_SW: "res://scenes/generation/caves/mine_corner_nw.tscn",
	DungeonGridData.RoomType.CAVE_T_JUNCTION: "res://scenes/generation/caves/mine_corner_se.tscn",
	DungeonGridData.RoomType.CAVE_CROSSROADS: "res://scenes/generation/caves/mine_chamber_small.tscn",
	DungeonGridData.RoomType.CAVE_DEAD_END: "res://scenes/generation/caves/mine_dead_end_small.tscn",
	DungeonGridData.RoomType.CAVE_CHAMBER: "res://scenes/generation/caves/mine_chamber_medium.tscn"
}
...
const MINE_PIECE_VARIANTS: Dictionary = {
	DungeonGridData.RoomType.CAVE_CORRIDOR_NS: [
		"res://scenes/generation/caves/mine_corridor_ns_standard.tscn",
		"res://scenes/generation/caves/mine_corridor_ns_long.tscn",
		"res://scenes/generation/caves/mine_ramp_down.tscn",
		"res://scenes/generation/caves/mine_ramp_long.tscn"
	],
	DungeonGridData.RoomType.CAVE_DEAD_END: [
		"res://scenes/generation/caves/mine_dead_end_small.tscn",
		"res://scenes/generation/caves/mine_dead_end_medium.tscn"
	],
	DungeonGridData.RoomType.CAVE_CHAMBER: [
		"res://scenes/generation/caves/mine_chamber_small.tscn",
		"res://scenes/generation/caves/mine_chamber_medium.tscn",
		"res://scenes/generation/caves/mine_hall_large.tscn"
	]
}
