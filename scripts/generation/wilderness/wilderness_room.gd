...
const TREE_PACK_BASE := "res://assets/sprites/legacy/environment/trees/tree_pack_1.1/tree_pack_1.1/models/"
...
const MUSHROOM_3D_MODELS: Array[String] = [
	"res://assets/world/nature/fabulous_mushroom_001.fbx",
	"res://assets/world/nature/fabulous_mushroom_002.fbx",
	"res://assets/world/nature/fabulous_mushroom_003.fbx",
	"res://assets/world/nature/fabulous_mushroom_004.fbx"
]
...
static func _init_texture_cache() -> void:
	...
	var grass_paths: Array[String] = [
		"res://assets/sprites/legacy/environment/ground/grassland_1.png",
		"res://assets/sprites/legacy/environment/ground/grassland_2.png",
		"res://assets/sprites/legacy/environment/ground/grassland_3.png"
	]
...
func _spawn_special_prop(parent: Node3D, pos: Vector3) -> void:
	...
	# const STATUE_MODEL := "res://assets/world/props/ancient_statue.glb"
	...
	if true:
		match biome:
			Biome.SWAMP:
				...
				special_textures = [
					"res://assets/sprites/legacy/props/dungeon/gravehead_1.png",
					"res://assets/sprites/legacy/props/dungeon/gravehead_2.png",
					"res://assets/sprites/legacy/props/dungeon/gravehead_3.png",
...
func _spawn_observation_tower(existing_positions: Array[Vector3]) -> void:
	...
	var tower_scene: PackedScene = load("res://scenes/world/observation_tower.tscn")
	if not tower_scene:
...
func _get_tree_texture() -> Texture2D:
	...
	match biome:
		Biome.FOREST:
			...
			return load("res://assets/sprites/legacy/environment/trees/autumn_tree_1.png")
		Biome.SWAMP:
			# Use swamp trees from cache
			if _tree_textures_swamp.size() > 0:
				return _tree_textures_swamp[rng.randi() % _tree_textures_swamp.size()]
			return load("res://assets/sprites/legacy/environment/trees/autumn_tree_2.png")
		Biome.PLAINS:
...
const HILLCROSS_MODEL_PATH := "res://assets/world/terrain/hillcross.glb"
...
## Swamp tree textures
const SWAMP_TREE_TEXTURE := "res://assets/sprites/legacy/environment/trees/swamp_tree1.png"
...
func _spawn_enemies() -> void:
	...
	# The main loop, not get_tree(): a room generated outside the tree used to
	# make this a method call on null, which aborts the function and meant the
	# world budget silently spawned no enemies at all. CellStreamer parents the
	# cell first now, but a caller that does not - the cliff-prop check, a dev
	# scene - must still get enemies rather than an abort. get_tree() itself is
	# avoided because it logs an engine error on the way to returning null.
...
func _get_enemy_config_for_biome() -> Dictionary:
	...
	var tier4_configs: Array[Dictionary] = [
		...
		},
		{
			...
			"sprite_path": "res://assets/sprites/legacy/enemies/undead/abomination.png",
			"h_frames": 1, "v_frames": 1,
...
const CLIFF_MODEL_PATHS: Array[String] = [
	"res://assets/world/nature/Cliff_01.obj",
	"res://assets/world/nature/Cliff_02.obj",
]
