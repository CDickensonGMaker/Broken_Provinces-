...
const STATUE_TEXTURES: Array[String] = [
	"res://assets/sprites/legacy/decorations/sword_statue1.png",
	"res://assets/sprites/legacy/decorations/sword_statue2.png",
	"res://assets/sprites/legacy/decorations/sword_statue3.png"
]
