...
const TREE_TEXTURES: Array[String] = [
	...
	"res://assets/sprites/environment/trees/green_sap_tree1.png",
	"res://assets/sprites/environment/trees/green_sap_tree2.png",
]

## Stump texture for chopped trees
const STUMP_TEXTURE: String = "res://assets/sprites/environment/trees/chopped_tree.png"
