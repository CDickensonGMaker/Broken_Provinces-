...
const GROUND := "res://assets/sprites/legacy/environment/ground/"
const TREE_PACK := "res://assets/sprites/legacy/environment/trees/tree_pack_1.1/tree_pack_1.1/models/"
...
static func tree_models(biome: int) -> Array[String]:
	match TerrainConfig.palette_of(biome):
		TerrainConfig.Biome.WINTER:
			return ["res://assets/world/nature/fir_001.fbx"]
		TerrainConfig.Biome.DESERT:
			return ["res://assets/world/props/cactus_001.fbx"]
		TerrainConfig.Biome.ROCKY:
			return []
		_:
			return []
...
static func billboard_trees(biome: int) -> Array[String]:
	const TREES := "res://assets/sprites/legacy/environment/trees/"
	match TerrainConfig.palette_of(biome):
		TerrainConfig.Biome.WOODLANDS:
