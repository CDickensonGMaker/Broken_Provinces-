...
const ROCK_SPRITE_PATH := "res://assets/sprites/legacy/world/rock.png"
const IRON_VEIN_SPRITE_PATH := "res://assets/sprites/legacy/world/iron_vein.png"
const SILVER_VEIN_SPRITE_PATH := "res://assets/sprites/legacy/world/silver_vein.png"
const GOLD_VEIN_SPRITE_PATH := "res://assets/sprites/legacy/world/gold_vein.png"
