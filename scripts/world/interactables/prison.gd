...
func _spawn_jail_guard() -> void:
	...
	var guard_script: Script = load("res://scripts/characters/npcs/jail_guard.gd")
	if guard_script:
...
func _create_cell_door_interactable() -> void:
	...
	var cell_door_script: Script = load("res://scripts/world/interactables/jail_cell_door.gd")
	if cell_door_script:
...
func _create_exit_door_interactable() -> void:
	...
	var exit_door_script: Script = load("res://scripts/world/interactables/jail_exit_door.gd")
	if exit_door_script:
