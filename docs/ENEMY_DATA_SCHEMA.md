...
```tres
sprite_path = "res://assets/sprites/legacy/enemies/human_bandit.png"
...
icon_path = "res://assets/sprites/legacy/enemies/human_bandit.png"
...
- `res://assets/sprites/legacy/enemies/beasts/wolf.png`
- `res://assets/sprites/legacy/enemies/humanoid/human_bandit.png`
- `res://assets/sprites/legacy/enemies/goblins/goblin_soldier.png`
...
sprite_path = "res://assets/sprites/legacy/enemies/wolf.png"  # Actually 4 frames
sprite_hframes = 1
sprite_vframes = 1

# GOOD - Matches actual sprite
sprite_path = "res://assets/sprites/legacy/enemies/wolf.png"
sprite_hframes = 4
sprite_vframes = 1
```
...
xp_reward = 75
scene_path = ""
icon_path = "res://assets/sprites/legacy/enemies/example.png"
scale = 1.0
sprite_path = "res://assets/sprites/legacy/enemies/example.png"
attack_sprite_path = ""
sprite_hframes = 4
sprite_vframes = 1
attack_hframes = 4
