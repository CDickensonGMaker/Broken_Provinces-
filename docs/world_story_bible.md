# Broken Provinces — World Story Bible
*Captured from Caleb by dictation, 2026-08-01. This is HIS story, structured — nothing invented. Gaps are marked `[OPEN]` and stay open until he answers. Canon hierarchy: this doc records the world story; `lore_bible.md` / `world_lore.md` hold prior written lore — where they conflict, ask Caleb, don't guess. Per the two-games ruling this is the universe story; The Empty Throne (this game) is the zoomed-in adventure inside it.*

## Origin & influences
- Based on **Caleb's own tabletop game** (published, but its storyline was only beginning to be written).
- **D&D Birthright campaign box** — owns it, never played it; loves the Gorgon, the source books, the scattered tidbits; there was never a collected campaign book, so this is his "fan version, fan universe" of that feeling.
- **The Lost Regiment** book series — the monstrous hordes model for the Tegnar.
- Genghis Khan hordes — Tegnar cultural model.

## The world at a glance
- **Far east: the human kingdoms** — where Broken Provinces: The Empty Throne takes place. A **crumbling empire**; that's the feel the player lives inside.
- **South of the start:** the dwarf fortress (Kazan-Dun) under goblin siege.
- **Further south, beyond mountain passes:** Tegnar lands. The in-game desert is their furthest outcropping — a Tegnar scouting camp (partially in the game files already).
- **A separate continent: the undead wasteland** (with its own internal story — see below).
- **Elves** — not fond of humans generally; keepers of the elixir knowledge. `[OPEN]` where exactly the elven lands sit (the lake crossing to the Elven City exists in game plans).
- **Ghost pirates** in the eastern/human lands (already started in-game).

## The main story — The Empty Throne
...
## The Kazan-Dun side quest — the dwarf succession (big, skippable flavor)
Not connected to the main story; a "huge flavor drop" the player can skip entirely.

- **The siege:** goblins came up through the lower caves. The fortress has **seven layers** with a **huge bridge at its middle** (Kazan's Span, in the files); the dwarves hold only the **top two levels**.
- **The hook:** after a couple of skirmishes, the **dwarf king is found dead at the bottom of the mine pits**. The goblins want to **sacrifice/eat his body** — feed it to their **goblin king** so he absorbs the power.
- **The soulstones:** the dwarves hold a **large stash of soulstones** (Warhammer-warpstone-adjacent in feel). The goblins with the soul gems + eating the king will do *something* that makes the goblin king stronger. `[OPEN]` the exact mechanism.
- **The stakes:** dwarves **cannot declare a new heir until the king's body receives proper funeral rites** — so the player must recover the body from goblin-held depths.
- **The succession split:**
  - The dead king left an **infant child**.
...
- They live **south of the dwarf fortress**, separated from the human lands by **mountain passes**.
