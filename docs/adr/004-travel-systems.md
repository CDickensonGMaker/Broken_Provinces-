...
**File:** `scripts/world/streaming/cell_streamer.gd`
...
**File:** `scripts/systems/travel/fast_travel_manager.gd`
...
**File:** `scripts/systems/travel/fast_travel_manager.gd` (lines 316-480)
...
**File:** `scripts/systems/travel/boat_travel_manager.gd`
...
| File | Purpose |
|------|---------|
| `scripts/systems/travel/fast_travel_manager.gd` | Fast travel + caravan stubs |
| `scripts/systems/travel/boat_travel_manager.gd` | Boat travel infrastructure |
| `scripts/world/streaming/cell_streamer.gd` | Walking/streaming |
| `scripts/core/world_grid.gd` | Road and location data |
