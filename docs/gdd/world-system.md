...
**Core Files:**
- `scripts/core/world_grid.gd` - World data and coordinate system
- `scripts/world/streaming/player_gps.gd` - Player position tracking
- `scripts/world/streaming/cell_streamer.gd` - Cell loading/unloading
