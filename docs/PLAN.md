...
**Existing Systems:**
- `TownGenerator` (scripts/generation/towns/town_generator.gd) - Procedural generation only
...
**Model Browser Panel:**
- Scans `res://assets/world/props/` and subfolders
...
```
- Path: res://assets/world/props/building_tower.glb
- Position: Vector3
